...
# out = cv.VideoWriter("Videos/output.mp4", cv.VideoWriter_fourcc(*'mp4v'), fps, (width, height))
#
# while cap.isOpened():
...
#             cv.putText(frame, f"{label} {conf:.2f}", (x1, y1 - 10),cv.FONT_HERSHEY_SIMPLEX, 0.5, (0, 255, 0 ), 2)
#
#
#     out.write(frame)
